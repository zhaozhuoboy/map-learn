	...
	this.map.on('click', (ev) => {
        ...
        let line = L.polyline(arr, {
          ...
          color: 'red',
            ...
            console.log(bounds)
            let a = bounds._northEast.lng + ' ' + bounds._northEast.lat;
            let b = bounds._southWest.lng + ' ' + bounds._southWest.lat;
            console.log(a,b)
            console.log(toGridList(a,b))
            L.polygon(toGridList(a,b)).addTo(this.map)
				  })
			  })
		  }
	  })
